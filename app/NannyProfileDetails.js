    ...
    if (!sessionStorage.getItem('LoginId')) {
      ...
      contactWrapper.innerHTML = `
                <ul class="contact-info-details">
                    <li>
                    <i class="fa-solid fa-envelope"></i><a href="mailto:${NannyProfileDetails.email}">${NannyProfileDetails.email}</a>
                    </li>
                    <li>
                    <i class="fa-solid fa-phone"></i><a href="tel:${NannyProfileDetails.contact}">${NannyProfileDetails.contact}</span>
                    </li>
                </ul>`;
    }
  }
...
function calculatePayment(days, payRate) {
  ...
  output.innerHTML = `
    <ul> 
        <li>Total: CAD${total}.</li>
        <li>GST: CAD${Math.ceil(GST)}</li>
        <li>PST: CAD${Math.ceil(PST)}</li>
    </ul>`
}
